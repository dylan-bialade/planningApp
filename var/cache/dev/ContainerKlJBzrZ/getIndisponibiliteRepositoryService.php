 ...
 */
class getIndisponibiliteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\IndisponibiliteRepository' shared autowired service.
     *
     * @return \App\Repository\IndisponibiliteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IndisponibiliteRepository.php';

        return $container->privates['App\\Repository\\IndisponibiliteRepository'] = new \App\Repository\IndisponibiliteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
