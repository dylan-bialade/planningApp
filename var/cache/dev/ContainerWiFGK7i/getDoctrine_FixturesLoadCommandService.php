...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'GroupeFixtures.php';
        ...
        $a->addFixtures([['fixture' => ($container->services['App\\DataFixtures\\AppFixtures'] ??= new \App\DataFixtures\AppFixtures()), 'groups' => []], ['fixture' => ($container->services['App\\DataFixtures\\GroupeFixtures'] ??= new \App\DataFixtures\GroupeFixtures()), 'groups' => []], ['fixture' => ($container->services['App\\DataFixtures\\PlanningFixtures'] ??= new \App\DataFixtures\PlanningFixtures()), 'groups' => []]]);
